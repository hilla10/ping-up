            ...
            <div
              ...
              <div className='flex flex-col gap-2 mt-4'>
                ...
                <button
                  ...
                  className='size-10 flex items-center justify-center text-sm rounded bg-slate-100 hover:bg-slate-200 active:scale-95 transition text-slate-800 cursor-pointer'>
